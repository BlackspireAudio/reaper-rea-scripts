-- @description Toggle mute on track under mouse (respect grouping, change selection, exclusive)
-- @version 1.0
-- @author BlackSpire
...
local undo_message = 'Toggle mute on track under mouse (respect grouping, change selection, exclusive)'
