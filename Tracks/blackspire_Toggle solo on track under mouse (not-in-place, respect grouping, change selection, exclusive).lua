-- @description Toggle solo on track under mouse (not-in-place, respect grouping, change selection, exclusive)
-- @version 1.0
-- @author BlackSpire
...
local undo_message = 'Toggle solo on track under mouse (not-in-place, respect grouping, change selection, exclusive)'
