-- @description Toggle solo on track under mouse (not-in-place, ignore grouping, change selection, exclusive)
-- @version 1.0
-- @author BlackSpire
...
local undo_message = 'Toggle solo on track under mouse (not-in-place, ignore grouping, change selection, exclusive)'
