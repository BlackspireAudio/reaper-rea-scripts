-- @description Toggle solo on track under mouse (in-place, ignore grouping, change selection)
-- @version 1.0
-- @author BlackSpire
...
local in_place = true
local undo_message = 'Toggle solo on track under mouse (in-place, ignore grouping, change selection)'
