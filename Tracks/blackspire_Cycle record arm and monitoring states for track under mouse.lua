...
local istrument_states = {
    [1] = { rec_arm = 0, rec_mode = 9, rec_mon = 1 }, -- unarmed
    [2] = { rec_arm = 1, rec_mode = 9, rec_mon = 1 }, -- record midi input (touch-replace) and monitor
    [3] = { rec_arm = 1, rec_mode = 7, rec_mon = 1 }, -- record midi input (overdub) and monitor
}
