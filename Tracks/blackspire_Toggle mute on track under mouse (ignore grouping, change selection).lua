-- @description Toggle mute on track under mouse (ignore grouping, change selection)
-- @version 1.0
-- @author BlackSpire
...
local undo_message = 'Toggle mute on track under mouse (ignore grouping, change selection)'
